                    ...
                    <div class="card p-4" style="width: 25rem;">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('Register') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <!-- Password input -->
                                <div class="form-outline mb-4">
                                    <input type="password" id="password" name="password" class="form-control" value="<?= old('nama');?>" />
                                ...
                                <input type="file" class="form-control mb-4" name="photo" id="photo" />
                                ...
                                <div class="text-center">
                                    <p>Sudah punya akun ? <a href="<?= route_to('/') ?>">Masuk di sini</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
